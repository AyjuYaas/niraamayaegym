  ...
  return (
    <div className="h-max bg-white text-black flex flex-col justify-center items-center p-10 gap-15 py-20">
      ...
      <p className="text-2xl md:text-3xl font-light text-center leading-10 md:leading-15">
        At Nirmaya Gym Assistance, we believe fitness is more than just
      ...
      <button className="px-15 py-8 md:px-20 md:py-10  relative z-2 bg-black text-white font-extrabold text-2xl md:text-3xl cursor-pointer border-5 hover:bg-[#85182a] hover:-translate-y-2 transition-all duration-250 ease-in-out">
        Join Our Community
      </button>
    </div>
  );
